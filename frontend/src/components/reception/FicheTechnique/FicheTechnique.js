        ...
        html2canvas(input, { scale: scale })
            .then(canvas => {
                ...
                demandes.forEach((demande, index) => {
                    ...
                    pdf.addImage(imgData, 'PNG', 0, startY, pdfWidth, pdfHeight);
                    startY += pdfHeight;

                    // Generate additional pages for samples if needed
                    const samplesPerPage = 2;
                    const totalPages = Math.ceil(demande.echantillons.length / samplesPerPage);
                            ...
                            <div className='container-ft'>
                                ...
                                <div className='info-perso'>
                                 ...
                                 <div className='info-perso'>
                                    ...
                                    <div className="form-group-ft-email">
                                        <label>Email:</label>
                                        <p>{demande.email}</p>
                                    </div>
                                    <div className="form-group-ft">
                                ...
                                <div className="form-header-ft">
                                            <p>Informations sur les échantillons</p>
                                </div>
                                <div>
                                                ...
                                                {echantillon.analyses.map((analyse, analyseIndex) => (
                                                    <div key={analyseIndex} >
                                                        <div className="form-group-ft">
                                                            ...
                                                            <li>Analyse {analyse.analysisType} de {analyse.parameter} par {analyse.technique} pour les elements : {analyse.elementsDinteret.map(e => e.elementDinteret).join(', ')}</li>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
