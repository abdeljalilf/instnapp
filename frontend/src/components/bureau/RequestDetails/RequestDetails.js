...
import './RequestDetails.css'; // Ensure the CSS file matches this path
...
const RequestDetails = () => {
    ...
    }, [id, department, apiBaseUrl, session_id]);
    ...
    // Group analyses by sample using the sample ID
    ...
    return (
        <div className='bureau-request-details'>
